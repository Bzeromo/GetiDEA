...
const Sidebar= () => {
  ...
  return (
    <div className="min-h-svh w-80 bg-side scrollbar  scrollbar-thumb-red ">
      <a className='flex flex-row mt-16 mb-10 p-4 justify-center items-center' href='/'>
         {/* 로고 이미지*/}
        <div className=" flex justify-center items-center">
        <img src="/logo.svg" alt="" className="object-cover h-12 w-12 "/>
        </div>
        {/* 로고 이름 */}
        <div className="text-[28px] text-center pl-3 font-inter font-bold rotate-[-0.03deg]">
        Get iDEA
        </div>
      </a>
      ...
      <ul>
        ...
        <li className="flex justify-center mb-3">
          <a className="flex flex-row text-center  block  rounded py-4 px-4  text-black" href="/">
            ...
            <span className='inline-block font-Nanum font-medium text-base mr-32 text-blue opacity-80 rotate-[-0.03deg]'>홈</span>
          </a>
        </li>

        {/* 최근 작업 버튼 */}
        <li className="flex justify-center mb-3">
          <a className="flex flex-row text-center  block  rounded py-4 px-4 bg-blue-500  hover:text-blue hover:opacity-80 text-black" href="/recent">
        ...
        {/* 북마크 버튼 */}
        <li className="flex justify-center mb-3">
          <a className="flex flex-row text-center  block  rounded py-4 px-4 bg-blue-500  hover:text-blue hover:opacity-80 text-black" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-5">
        ...
        <div className="py-2 flex  justify-center ">
			    <details className="group">
				  ...
				  <summary className="w-56 justify-center rounded py-4 px-4 hover:text-blue hover:opacity-80 flex  text-center  items-center font-medium cursor-pointer list-none">
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-5">
            ...
            <span className='inline-block  font-Nanum font-medium text-base rotate-[-0.03deg]'>모든 프로젝트</span>
              ...
              <li className="flex justify-center mb-3  ">
                <a className="w-56 flex flex-row text-center  block  rounded py-4 px-4 text-black hover:text-blue hover:opacity-80 " href="#">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-5">
                ...
                <li className="flex justify-center mb-3 ">
                  <a className="w-56 flex flex-row text-center  block  rounded py-4 px-4 bg-blue-500  hover:text-blue hover:opacity-80 text-black" href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                  </svg>
                ...
                {/* 새로운 폴더 만들기 */}
                <li className="flex justify-center mb-3 ">
                  <div className="hover:bg-white  w-56 flex flex-row text-center  block  rounded py-4 px-4 ">
