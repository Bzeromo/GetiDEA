    ...
    <div className="ml-24 mt-10 flex " style={{ width: '800px', height: '300px' }}>
      <div>
        ...
        <div className='flex flex-row mt-5'>
          ...
          <Link to="/templateSelect" className='hover:scale-105 duration-500 w-56 h-56 mr-8 bg-[#B8D8DC]  opacity-60 drop-shadow-lg flex justify-center flex-col items-center' >
          ...
          <div className='hover:scale-105 duration-500 w-56 h-56 mr-8 bg-white  drop-shadow-lg flex justify-center flex-col items-center'>
            <img src="/projectImage1.png" alt="" className='w-36 h-36 object-cover ' />
            <span className='inline-block font-Nanum text-xl font-semibold rotate-[-0.03deg] '>프로젝트 1</span>
          </div>

          <div className='hover:scale-105  duration-500 w-56 h-56 mr-8 bg-white  drop-shadow-lg flex justify-center flex-col items-center'>
            <img src="/projectImage2.png" alt="" className='w-full h-36 object-cover ' />
